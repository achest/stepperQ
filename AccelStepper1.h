// AccelStepper1.h
//
/// \mainpage AccelStepper1 library for Arduino
///
/// This is the Arduino AccelStepper1 library.
...
///
/// AccelStepper1 significantly improves on the standard Arduino Stepper library in several ways:
...
/// http://www.airspayce.com/mikem/arduino/AccelStepper1
/// The version of the package that this documentation refers to can be downloaded 
/// from http://www.airspayce.com/mikem/arduino/AccelStepper1/AccelStepper1-1.37.zip
///
/// Example Arduino programs are included to show the main modes of use.
///
/// You can also find online help and discussion at http://groups.google.com/group/AccelStepper1
...
/// with the exception that AccelStepper1 uses steps per second rather than radians per second
...
///               specifying AccelStepper1::FULL4WIRE and friends.
...
// $Id: AccelStepper1.h,v 1.19 2013/08/02 01:53:21 mikem Exp mikem $
...
/////////////////////////////////////////////////////////////////////
/// \class AccelStepper1 AccelStepper1.h <AccelStepper1.h>
...
/// AccelStepper1 will not have a correct 
...
public:
    ...
    /// AccelStepper1::DRIVER (1) means a stepper driver (with Step and Direction pins).
    /// If an enable line is also needed, call setEnablePin() after construction.
    /// You may also invert the pins using setPinsInverted().
    /// AccelStepper1::FULL2WIRE (2) means a 2 wire stepper (2 pins required). 
    /// AccelStepper1::FULL3WIRE (3) means a 3 wire stepper, such as HDD spindle (3 pins required). 
    /// AccelStepper1::FULL4WIRE (4) means a 4 wire stepper (4 pins required). 
    /// AccelStepper1::HALF3WIRE (6) means a 3 wire half stepper, such as HDD spindle (3 pins required)
    /// AccelStepper1::HALF4WIRE (8) means a 4 wire half stepper (4 pins required)
    /// Defaults to AccelStepper1::FULL4WIRE (4) pins.
    /// \param[in] pin1 Arduino digital pin number for motor pin 1. Defaults
    /// to pin 2. For a AccelStepper1::DRIVER (pins==1), 
    /// this is the Step input to the driver. Low to high transition means to step)
    /// \param[in] pin2 Arduino digital pin number for motor pin 2. Defaults
    /// to pin 3. For a AccelStepper1::DRIVER (pins==1), 
